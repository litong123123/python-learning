...
#messages_from_dict:字典列表-->消息列表 [字典，字典，字典...]--->[消息，消息，消息...]
...
conversation_chain=RunnableWithMessageHistory(
    ...
    history_messages_key="chat_history", #表示历史消息在模版中的占位符
)

if __name__ == '__main__':  #当这个文件被直接运行时，才执行下面的代码
    ...
    print("第1次执行",res)
    res = conversation_chain.invoke({"input": "小王有1个狗"}, session_config)
    print("第2次执行", res)
